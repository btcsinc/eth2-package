...
static_files = import_module("github.com/btcsinc/eth2-package/src/static_files/static_files.star")
genesis_constants = import_module("github.com/btcsinc/eth-network-package/src/prelaunch_data_generator/genesis_constants/genesis_constants.star")

eth_network_module = import_module("github.com/btcsinc/eth-network-package/main.star")
transaction_spammer = import_module("github.com/btcsinc/eth2-package/src/transaction_spammer/transaction_spammer.star")
cl_forkmon = import_module("github.com/btcsinc/eth2-package/src/cl_forkmon/cl_forkmon_launcher.star")
el_forkmon = import_module("github.com/btcsinc/eth2-package/src/el_forkmon/el_forkmon_launcher.star")
beacon_metrics_gazer = import_module("github.com/btcsinc/eth2-package/src/beacon_metrics_gazer/beacon_metrics_gazer_launcher.star")
light_beaconchain_explorer = import_module("github.com/btcsinc/eth2-package/src/light_beaconchain/light_beaconchain_launcher.star")
prometheus = import_module("github.com/btcsinc/eth2-package/src/prometheus/prometheus_launcher.star")
grafana =import_module("github.com/btcsinc/eth2-package/src/grafana/grafana_launcher.star")
testnet_verifier = import_module("github.com/btcsinc/eth2-package/src/testnet_verifier/testnet_verifier.star")
mev_boost_launcher_module = import_module("github.com/btcsinc/eth2-package/src/mev_boost/mev_boost_launcher.star")
mock_mev_launcher_module = import_module("github.com/btcsinc/eth2-package/src/mock_mev/mock_mev_launcher.star")
mev_relay_launcher_module = import_module("github.com/btcsinc/eth2-package/src/mev_relay/mev_relay_launcher.star")
mev_flood_module = import_module("github.com/btcsinc/eth2-package/src/mev_flood/mev_flood_launcher.star")
